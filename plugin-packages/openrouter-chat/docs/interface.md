# OpenRouter Chat 接口字段

## 协议身份

- 插件 ID：`openrouter-chat`。
- Provider ID：`openrouter-chat`。
- 能力：`text`。
- 默认 Base URL：`https://openrouter.ai/api`。
- 鉴权驱动：`bearer`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.openrouter-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.openrouter-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.openrouter-chat.extra_body`
- `providerOptions.openrouter-chat.max_tokens`
- `providerOptions.openrouter-chat.provider`
- `providerOptions.openrouter-chat.response_format`
- `providerOptions.openrouter-chat.stream`
- `providerOptions.openrouter-chat.temperature`
- `providerOptions.openrouter-chat.tool_choice`
- `providerOptions.openrouter-chat.tools`
- `providerOptions.openrouter-chat.top_p`
- `providerOptions.openrouter-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.openrouter-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.openrouter-chat.extra_body"
              }
            }
          }
        },
