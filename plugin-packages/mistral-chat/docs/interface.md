...
- 插件 ID：`mistral-chat`。
- Provider ID：`mistral-chat`。
- 能力：`text`。
- 默认 Base URL：`https://api.mistral.ai`。
- 鉴权驱动：`bearer`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.mistral-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.mistral-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.mistral-chat.extra_body`
- `providerOptions.mistral-chat.max_tokens`
- `providerOptions.mistral-chat.provider`
- `providerOptions.mistral-chat.response_format`
- `providerOptions.mistral-chat.stream`
- `providerOptions.mistral-chat.temperature`
- `providerOptions.mistral-chat.tool_choice`
- `providerOptions.mistral-chat.tools`
- `providerOptions.mistral-chat.top_p`
- `providerOptions.mistral-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.mistral-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.mistral-chat.extra_body"
              }
            }
          }
        },
