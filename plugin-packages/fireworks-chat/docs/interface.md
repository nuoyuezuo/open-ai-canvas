...
- 插件 ID：`fireworks-chat`。
- Provider ID：`fireworks-chat`。
- 能力：`text`。
- 默认 Base URL：`https://api.fireworks.ai/inference`。
- 鉴权驱动：`bearer`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.fireworks-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.fireworks-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.fireworks-chat.extra_body`
- `providerOptions.fireworks-chat.max_tokens`
- `providerOptions.fireworks-chat.provider`
- `providerOptions.fireworks-chat.response_format`
- `providerOptions.fireworks-chat.stream`
- `providerOptions.fireworks-chat.temperature`
- `providerOptions.fireworks-chat.tool_choice`
- `providerOptions.fireworks-chat.tools`
- `providerOptions.fireworks-chat.top_p`
- `providerOptions.fireworks-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.fireworks-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.fireworks-chat.extra_body"
              }
            }
          }
        },
