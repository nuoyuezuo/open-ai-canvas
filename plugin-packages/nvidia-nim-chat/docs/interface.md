# NVIDIA NIM Chat 接口字段

## 协议身份

- 插件 ID：`nvidia-nim-chat`。
- Provider ID：`nvidia-nim-chat`。
- 能力：`text`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.nvidia-nim-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.nvidia-nim-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.nvidia-nim-chat.extra_body`
- `providerOptions.nvidia-nim-chat.max_tokens`
- `providerOptions.nvidia-nim-chat.provider`
- `providerOptions.nvidia-nim-chat.response_format`
- `providerOptions.nvidia-nim-chat.stream`
- `providerOptions.nvidia-nim-chat.temperature`
- `providerOptions.nvidia-nim-chat.tool_choice`
- `providerOptions.nvidia-nim-chat.tools`
- `providerOptions.nvidia-nim-chat.top_p`
- `providerOptions.nvidia-nim-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.nvidia-nim-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.nvidia-nim-chat.extra_body"
              }
            }
          }
        },
