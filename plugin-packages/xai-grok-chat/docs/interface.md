...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.xai-grok-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.xai-grok-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.xai-grok-chat.extra_body`
- `providerOptions.xai-grok-chat.max_tokens`
- `providerOptions.xai-grok-chat.provider`
- `providerOptions.xai-grok-chat.response_format`
- `providerOptions.xai-grok-chat.stream`
- `providerOptions.xai-grok-chat.temperature`
- `providerOptions.xai-grok-chat.tool_choice`
- `providerOptions.xai-grok-chat.tools`
- `providerOptions.xai-grok-chat.top_p`
- `providerOptions.xai-grok-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.xai-grok-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.xai-grok-chat.extra_body"
              }
            }
          }
        },
