# Together AI Chat 接口字段

## 协议身份

- 插件 ID：`together-chat`。
- Provider ID：`together-chat`。
- 能力：`text`。
- 默认 Base URL：`https://api.together.xyz`。
- 鉴权驱动：`bearer`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.together-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.together-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.together-chat.extra_body`
- `providerOptions.together-chat.max_tokens`
- `providerOptions.together-chat.provider`
- `providerOptions.together-chat.response_format`
- `providerOptions.together-chat.stream`
- `providerOptions.together-chat.temperature`
- `providerOptions.together-chat.tool_choice`
- `providerOptions.together-chat.tools`
- `providerOptions.together-chat.top_p`
- `providerOptions.together-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.together-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.together-chat.extra_body"
              }
            }
          }
        },
