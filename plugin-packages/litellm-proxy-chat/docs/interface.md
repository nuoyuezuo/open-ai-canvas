# LiteLLM Proxy Chat 接口字段

## 协议身份

- 插件 ID：`litellm-proxy-chat`。
- Provider ID：`litellm-proxy-chat`。
- 能力：`text`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.litellm-proxy-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.litellm-proxy-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.litellm-proxy-chat.extra_body`
- `providerOptions.litellm-proxy-chat.max_tokens`
- `providerOptions.litellm-proxy-chat.provider`
- `providerOptions.litellm-proxy-chat.response_format`
- `providerOptions.litellm-proxy-chat.stream`
- `providerOptions.litellm-proxy-chat.temperature`
- `providerOptions.litellm-proxy-chat.tool_choice`
- `providerOptions.litellm-proxy-chat.tools`
- `providerOptions.litellm-proxy-chat.top_p`
- `providerOptions.litellm-proxy-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.litellm-proxy-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.litellm-proxy-chat.extra_body"
              }
            }
          }
        },
