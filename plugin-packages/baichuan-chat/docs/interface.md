...
- 插件 ID：`baichuan-chat`。
- Provider ID：`baichuan-chat`。
- 能力：`text`。
- 默认 Base URL：`https://api.baichuan-ai.com`。
- 鉴权驱动：`bearer`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.baichuan-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.baichuan-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.baichuan-chat.extra_body`
- `providerOptions.baichuan-chat.max_tokens`
- `providerOptions.baichuan-chat.provider`
- `providerOptions.baichuan-chat.response_format`
- `providerOptions.baichuan-chat.stream`
- `providerOptions.baichuan-chat.temperature`
- `providerOptions.baichuan-chat.tool_choice`
- `providerOptions.baichuan-chat.tools`
- `providerOptions.baichuan-chat.top_p`
- `providerOptions.baichuan-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.baichuan-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.baichuan-chat.extra_body"
              }
            }
          }
        },
