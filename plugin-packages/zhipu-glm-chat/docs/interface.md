...
- 插件 ID：`zhipu-glm-chat`。
- Provider ID：`zhipu-glm-chat`。
- 能力：`text`。
- 默认 Base URL：`https://open.bigmodel.cn/api/paas`。
- 鉴权驱动：`bearer`。
...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.zhipu-glm-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.stream"}}` |
| `create.body.provider` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.provider"}}` |
| `create.body.transforms` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.transforms"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.zhipu-glm-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.zhipu-glm-chat.extra_body`
- `providerOptions.zhipu-glm-chat.max_tokens`
- `providerOptions.zhipu-glm-chat.provider`
- `providerOptions.zhipu-glm-chat.response_format`
- `providerOptions.zhipu-glm-chat.stream`
- `providerOptions.zhipu-glm-chat.temperature`
- `providerOptions.zhipu-glm-chat.tool_choice`
- `providerOptions.zhipu-glm-chat.tools`
- `providerOptions.zhipu-glm-chat.top_p`
- `providerOptions.zhipu-glm-chat.transforms`
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.zhipu-glm-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.stream"
              }
            },
            "provider": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.provider"
              }
            },
            "transforms": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.transforms"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.zhipu-glm-chat.extra_body"
              }
            }
          }
        },
