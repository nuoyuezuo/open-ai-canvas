# AWS Bedrock InvokeModel 接口字段

## 协议身份

- 插件 ID：`aws-bedrock-invoke-model`。
- Provider ID：`aws-bedrock-invoke-model`。
- 能力：`text`。
- 默认 Base URL：`https://bedrock-runtime.{region}.amazonaws.com`。
- 鉴权驱动：`aws-sigv4`。
- 创建：`POST /model/{{model}}/invoke`。
- 生命周期：同步响应。
...
| --- | --- |
| `create.method` | `"POST"` |
| `create.path` | `"/model/{{model}}/invoke"` |
| `create.contentType` | `"application/json"` |
| `create.body` | `{"$merge":[{"model":{"$ref":"request.model"},"messages":{"$ref":"request.messages"},"input":{"$omitEmpty":{"$ref":"request.prompt"}},"parameters":{"$omitEmpty":{"$ref":"request.providerOptions.aws-bedrock-invoke-model.parameters"}}},{"$coalesce":[{"$ref":"request.providerOptions.aws-bedrock-invoke-model.body"},{"$ref":"request.providerOptions.aws-bedrock-invoke-model.extra_body"},{}]}]}` |

## Provider 扩展键

- `providerOptions.aws-bedrock-invoke-model.body`
- `providerOptions.aws-bedrock-invoke-model.extra_body`
- `providerOptions.aws-bedrock-invoke-model.parameters`
            ...
            "$merge": [
              {
                ...
                "parameters": {
                  "$omitEmpty": {
                    "$ref": "request.providerOptions.aws-bedrock-invoke-model.parameters"
                  }
                }
              },
              {
                "$coalesce": [
                  {
                    "$ref": "request.providerOptions.aws-bedrock-invoke-model.body"
                  },
                  {
                    "$ref": "request.providerOptions.aws-bedrock-invoke-model.extra_body"
                  },
                  {}
                ]
              }
