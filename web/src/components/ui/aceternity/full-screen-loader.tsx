    ...
    return (
        ...
        >
            <div className="full-screen-loader-scene" aria-hidden="true">
                ...
                <BrandLogoFrame className="full-screen-loader-logo" logoClassName="full-screen-loader-logo-image" alt="" />
            </div>
    ...
    return (
        <section data-workspace-route-loader className={cn("workspace-route-loader", visible && "is-visible")} role="status" aria-live="polite" aria-label={label}>
            <div className="workspace-route-loader-content">
                <span className="workspace-route-loader-mark"><BrandLogoFrame className="workspace-route-loader-logo" logoClassName="size-4" alt="" /></span>
                <LoadingSignal />
                <span>{label}</span>
            </div>
        </section>
