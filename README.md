<p align="center">
  <img src="web/public/logo.svg" width="88" alt="才遇 logo">
</p>

<h1 align="center">才遇</h1>
...
才遇是一个开源的 AI 影视与短剧创作工作台：用自由画布组织创作，用结构化工作流管理剧本、角色、场景和分镜，并通过统一的任务系统完成图片、视频、音频与文本生成。
...
<p align="center">
  <img src="assets/wx.jpg" alt="才遇 微信交流群" width="100%">
</p>

## 许可证和上游

本项目采用 [MIT](LICENSE) 协议。才遇基于 [basketikun/infinite-canvas](https://github.com/basketikun/infinite-canvas) 的早期版本进行二次开发，上游作者和贡献者保留其对应代码的权利与署名。
